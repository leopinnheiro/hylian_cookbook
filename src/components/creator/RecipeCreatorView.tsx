...
export function RecipeCreatorView({
  ...
  const isFullHeal = result.hearts === 120;
  const heartsDisplay = isFullHeal ? null : getHeartsDisplay(result.hearts);
